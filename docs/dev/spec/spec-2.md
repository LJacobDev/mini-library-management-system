...
- **Iconography**: `@nuxt/icon` with Heroicons outline by default, allowing quick swaps to civic-specific icon sets later.
- **Image handling**: `@nuxt/image` for responsive cover art, placeholder blur, and future asset optimisation.
