...
- 2025-11-13 — `AuthPanel` adds a sign-up mode with password confirmation, toggles between login and registration in-place, and uses the new Supabase `signUpWithPassword` helper for account creation.