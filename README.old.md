...
- Those in the [agents directory](agents/old-approach), where a manager agent and three implementation agents kept track of their individual context, instructions, and a history of their progress.  Example: [Agent-manager-context.md](agents/agent-manager-context.md).
